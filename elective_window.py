...
class Ui_elective_window(object):
    def setupUi(self, elective_window):
        ...
        self.sections_spinbox.setMinimumSize(QtCore.QSize(110, 30))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        elective_window.setTabOrder(self.semester_combobox, self.sections_spinbox)
        elective_window.setTabOrder(self.sections_spinbox, self.electiveGroup_combobox)
    ...
    def retranslateUi(self, elective_window):
        ...
        self.editBtn.setText(_translate("elective_window", "Edit"))
