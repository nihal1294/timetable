...
class Ui_elective_window(object):
    def setupUi(self, elective_window):
        ...
        elective_window.resize(714, 502)
        ...
        elective_window.setMinimumSize(QtCore.QSize(714, 502))
        elective_window.setMaximumSize(QtCore.QSize(714, 502))
        self.centralWidget = QtWidgets.QWidget(elective_window)
        self.centralWidget.setGeometry(QtCore.QRect(0, 0, 714, 502))
        ...
        self.elective_list.setMinimumSize(QtCore.QSize(225, 0))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.elective_code_input.setMinimumSize(QtCore.QSize(100, 30))
        font = QtGui.QFont()
        font.setPointSize(12)
    ...
    def retranslateUi(self, elective_window):
        ...
        elective_window.setWindowTitle(_translate("elective_window", "Elective Entry"))
