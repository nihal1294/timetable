...
class Ui_window(object):
    def setupUi(self, window):
        ...
        window.setStyleSheet(darkstyle.css)
        ...
        self.menuFile.setGeometry(QtCore.QRect(226, 100, 135, 138))
