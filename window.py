...
class Ui_window(object):
    def setupUi(self, window):
        ...
        self.gridLayout.addWidget(self.sections_spinbox, 6, 3, 1, 1)
        ...
        self.menuFile.setGeometry(QtCore.QRect(288, 100, 135, 116))
        ...
        window.setTabOrder(self.subject_short_input, self.lab_checkbox)
        window.setTabOrder(self.lab_checkbox, self.credits_spinbox)
        window.setTabOrder(self.credits_spinbox, self.addBtn)
        window.setTabOrder(self.addBtn, self.removeBtn)
        window.setTabOrder(self.removeBtn, self.input_list)
        window.setTabOrder(self.input_list, self.nextBtn)
